...
class FacebookIcon extends Component {
    render() {
        return (
            <svg width="65%" height="65%" viewBox="0 0 120 120" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 xmlnsXlink="http://www.w3.org/1999/xlink">
                <title>facebook_button</title>
